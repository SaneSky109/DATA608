...
### Takeaway
 ...
 - Regular season success does not always translate to success in the post season.
 - Goaltending is valuable in both regular season and playoffs
 - Winning faceoffs in odd manned situations is valuable for both regular season and playoffs
 - The `CorsiPercentage` statistic is one of the most important metrics to boost for success in both regular season and playoff games.